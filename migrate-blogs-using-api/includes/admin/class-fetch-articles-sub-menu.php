...
if ( ! class_exists( 'Fetch_Authors_Articles_Sub_Menu' ) ) {
    ...
    class Fetch_Authors_Articles_Sub_Menu {
         ...
         */
        public function get_user_identification_meta_key() {
            /**
         ...
         */
        public function get_user_identification_meta_value() {
            /**
        ...
        public function fetch_authors_action() {
            ...
            foreach ( $authors_data as $author_data ) {
                if ( email_exists( $author_data[ 'email' ] ) || username_exists( $author_data[ 'username' ] ) ) {
                    ...
                    update_user_meta( $user_id, 'address_street', $author_data[ 'address' ][ 'street' ] );
                    update_user_meta( $user_id, 'address_suite', $author_data[ 'address' ][ 'suite' ] );
                    update_user_meta( $user_id, 'address_city', $author_data[ 'address' ][ 'city'] );
                    update_user_meta( $user_id, 'address_pincode', $author_data[ 'address' ][ 'zipcode' ] );
                    update_user_meta( $user_id, 'phone', $author_data[ 'phone' ] );
                    update_user_meta( $user_id, 'company_name', $author_data[ 'company' ][ 'name' ] );
                    update_user_meta( $user_id, 'website', $author_data[ 'website' ] );
                    update_user_meta( $user_id, $this->get_user_identification_meta_key(), $this->get_user_identification_meta_value() );
        ...
        public function fetch_articles_action() {
            ...
            $authors_id = get_users(
                array(
                    'meta_key'   => $this->get_user_identification_meta_key(),
                    'meta_value' => $this->get_user_identification_meta_value(),
                    'fields'     => 'ID',
                )
            );
